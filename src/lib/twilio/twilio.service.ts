...
import { MODULE_OPTIONS_TOKEN } from '@src/lib/twilio/twilio.module-definition';
import { TwilioModuleOptions } from '@src/lib/twilio/twilio.options';
...
export class TwilioService {
  ...
  sendSms(
    ...
    const client = twilio(
      ...
      omit(this.options, ['accountSid', 'authToken', 'from']),
    );
